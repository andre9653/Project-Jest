...
describe('verifica as funções e os mocks', () => {
  ...
  test('testa função add', () => {
    const mockAdd = jest.fn(mockFunctions.add)
  ...
  test('testa função subtract', () => {
    const mockSubtract = jest.fn(mockFunctions.subtract)
      .mockImplementation((a, b) => a - b);
  ...
  test('testa função multiply', () => {
    const mockMultiply = jest.fn(mockFunctions.multiply)
      .mockImplementation((a, b) => a * b);
  ...
  test('testa função divide', () => {
    const mockDivide = jest.fn(mockFunctions.divide)
      .mockImplementation((a, b) => a / b);
  ...
  test('testa função power', () => {
    const mockPower = jest.fn(mockFunctions.power)
      .mockImplementation((a, b) => a ** b);
  ...
  // referencia https://gist.github.com/macsousa/dccd2abb2c68c5958846824e975482d3
  test('testa função factorial', () => {
    const fatorial = (valor) => {
      let acumula = 1;
      for (let x = valor; x > 1; x -= 1) {
        acumula *= x;
      }
      return acumula;
    };
    const mockFactorial = jest.fn(mockFunctions.factorial)
      .mockImplementation((n) => (n === 0 || n === 1 ? 1 : n * fatorial(n - 1)));
